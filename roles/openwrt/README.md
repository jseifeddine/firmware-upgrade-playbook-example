...
***FORKED from [gekmihesg/ansible-openwrt](https://github.com/gekmihesg/ansible-openwrt)***

N.B: Minor adjustments made to suit Teltonika's flavour of OpenWRT, namely: disabling package repository tasks and using renamed `opkg-solo` in `library/openwrt_opkg.sh`
